        ...
        <div className='bg-white dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className="text-2xl">$87,351.93</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      <div className="flex gap-10 flex-wrap justify-center">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className='text-3xl dark:text-gray-200 font-semibold'>$93,438</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl dark:text-gray-200 font-semibold'>$48,438</span>
                </p>
