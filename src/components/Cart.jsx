...
const Cart = () => {
  ...
  useEffect(() => {
    const handleOutsideClick = (event) => {
      if (cartRef.current && !cartRef.current.contains(event.target) && isVisible.cart) {
        handleClick('cart');
      }
    };
  ...
  return (
    <div ref={cartRef} className={`nav-item absolute right-1 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96 shadow-lg ${isVisible.cart ? 'visible' : 'hidden'}`}>
      <div className="flex justify-between items-center">
        <p className="font-semibold dark:text-gray-200 text-lg">Shopping Cart</p>
        <Button
              ...
              <div className="flex items-center   leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4">
                ...
                <div>
                  ...
                  <div className="flex gap-4 mt-2 items-center">
                    <p className="font-semibold dark:text-gray-400 text-lg">{item.price}</p>
        ...
        <div className="mt-3 mb-3">
          <div className="flex justify-between items-center">
            ...
            <p className="font-semibold dark:text-gray-400">$890</p>
          </div>
